...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        server::routes::workspaces::images::AssociateWorkspaceImagesRequest::decl(),
        server::routes::workspaces::images::ImportIssueAttachmentsRequest::decl(),
        server::routes::workspaces::images::ImportIssueAttachmentsResponse::decl(),
