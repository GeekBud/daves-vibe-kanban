...
export type StatusResponse = { logged_in: boolean, profile: ProfileResponse | null, degraded: boolean | null, local_mode: boolean | null, };
 ...
 */
capabilities: { [key in string]?: Array<BaseAgentCapability> }, shared_api_base: string | null, preview_proxy_port: number | null, local_mode: boolean, executors: { [key in BaseCodingAgent]?: ExecutorProfile }, };
...
export type ExecutorProfile = { recently_used_models?: ExecutorRecentModels | null, } & ({ [key in string]?: { "CLAUDE_CODE": ClaudeCode } | { "AMP": Amp } | { "GEMINI": Gemini } | { "CODEX": Codex } | { "OPENCODE": Opencode } | { "CURSOR_AGENT": CursorAgent } | { "QWEN_CODE": QwenCode } | { "COPILOT": Copilot } | { "DROID": Droid } | { "KIMI_CODE": KimiCode } });
...
export type KimiCode = { append_prompt: AppendPrompt, model?: string | null, yolo?: boolean | null, thinking?: boolean | null, base_command_override?: string | null, additional_params?: Array<string> | null, env?: { [key in string]?: string } | null, };
